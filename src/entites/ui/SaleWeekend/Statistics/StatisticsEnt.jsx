...
import styles from './StatisticsEnt.module.scss';

function StatisticsEnt(props) {
  return (
    <div className={styles.statistics}>
      <div className="container">
        <div className={styles.items}>
          <div className={styles.first}>
            <div className={styles.first__title}>10K+</div>
            <div className={styles.first__text}>Satisfied Costumers All Great Over The World</div>
          </div>
          <div className={styles.second}>
            <div className={styles.second__title}>4M</div>
            <div className={styles.second__text}>
              Healthy Dishes Sold Including Milk Shakes Smooth
            </div>
          </div>
          <div className={styles.third}>
            <div className={styles.third__title}>99.99%</div>
      ...
      <div className={styles.line}>
        <div className={styles.line__first}>
          <svg
            width="428"
            height="225"
            viewBox="0 0 428 221"
        ...
        <div className={styles.line__second}>
          <svg
            width="384"
            height="225"
            viewBox="0 0 384 221"
      ...
      <div className={styles.wave}>
        <div className={styles.wave__first}>
          <svg
            width="128"
            height="221"
            viewBox="0 0 128 221"
            ...
            <path
              ...
              stroke="#A596FF"
              stroke-width="4.44874"
              stroke-linecap="round"
            />
          </svg>
        </div>
        <div className={styles.wave__second}>
          <svg
            width="88"
            height="221"
            viewBox="0 0 88 221"
