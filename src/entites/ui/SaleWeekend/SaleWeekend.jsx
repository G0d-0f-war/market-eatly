...
export default function SaleWeekend () { 
    ...
    <div className={styles.banner}>
        ...
        <div className={styles.lines}><img src={Lines} alt="" /></div>
            <div className={styles.title}>50% OFF <br /> <p>WEEKENDS</p></div>
            <div className={styles.FoodImg}><img src={FoodImg} alt="" /></div>
    </div>
    );
};